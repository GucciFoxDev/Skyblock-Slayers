...
public class ZombieSlayerLevelManager {

    @Getter @Setter private int level;
    @Getter @Setter private int xp;
    public int maxLevel = 9;

    public ZombieSlayerLevelManager(int level, int xp) {
        this.level = level;
        this.xp = xp;
    }
    ...
    /**
     *
     * @return formatted next levels xp and non formatted (string)
     */
    public String getNextLevelXp() {
        int nextLevelXp = Slayers.getPlugin().getConfig().getInt("Zombie.Levels." + getNextLevel() + ".xp");
        if (nextLevelXp < 1000) {
    ...
    public int getNextLevelXpInt() {
        return Slayers.getPlugin().getConfig().getInt("Zombie.Levels." + getNextLevel() + ".xp");
    }
    ...
    public String getXpTillNextLevel() {
        int xpTillNextLevel = Slayers.getPlugin().getConfig().getInt("Zombie.Levels." + getNextLevel() + ".xp") - xp;
    ...
    /**
     *
     * @return formatted value for their xp
     */
    ...
    /**
     *
     * @return max level for zombie slayers
     */
