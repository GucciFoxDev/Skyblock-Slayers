...
public class RevenantFlesh extends CustomItem {
    public RevenantFlesh(int id, Rarity rarity, String name, Material material, int durability, boolean stackable, boolean oneTimeUse, boolean hasActive, List<ItemAbility> abilities, int manaCost, boolean reforgeable, ItemType itemType, boolean glowing) {
    ...
    public void getSpecificLorePrefix(List<String> paramList, ItemStack paramItemStack) {
        paramList.add("§eRight-click to view recipes!");
    }
