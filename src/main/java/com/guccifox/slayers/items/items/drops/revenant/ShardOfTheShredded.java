...
public class ShardOfTheShredded extends CustomItem {
    public ShardOfTheShredded(int id, Rarity rarity, String name, Material material, int durability, boolean stackable, boolean oneTimeUse, boolean hasActive, List<ItemAbility> abilities, int manaCost, boolean reforgeable, ItemType itemType, String url, boolean glowing) {
    ...
    public void getSpecificLorePrefix(List<String> lore, ItemStack paramItemStack) {
        lore.add("§7The core of a powerful weapon,");
        lore.add("§7dropped by the Atoned Horror.");
        lore.add("§r");
