...
public class FoulFlesh extends CustomItem {
    public FoulFlesh(int id, Rarity rarity, String name, Material material, int durability, boolean stackable, boolean oneTimeUse, boolean hasActive, List<ItemAbility> abilities, int manaCost, boolean reforgeable, ItemType itemType, boolean glowing) {
    ...
    public void getSpecificLorePrefix(List<String> paramList, ItemStack paramItemStack) {
        paramList.add("§8Brewing Ingredient");
        paramList.add("§7Increases the speed of");
        paramList.add("§7your minion by §a%90");
        paramList.add("§7for 5 hours!");
    }
