...
public class SnakeRune extends CustomItem {
    public SnakeRune(int id, Rarity rarity, String name, Material material, int durability, boolean stackable, boolean oneTimeUse, boolean hasActive, List<ItemAbility> abilities, int manaCost, boolean reforgeable, ItemType itemType, String url, boolean glowing) {
    ...
    public void getSpecificLorePrefix(List<String> lore, ItemStack paramItemStack) {
        lore.add("§8Requires level 21");
        lore.add("§8Boots");
        lore.add("§r");
        lore.add("§7Obtained very rarely from");
        lore.add("§7slaying the Revenant Horror");
        lore.add("§r");
        lore.add("§7Apply this rune to boots or fuse");
        lore.add("§7two together at the Runic");
        lore.add("§7Pedestal!");
    }
